...
export const UserCard = (props) => {
  const handleClick = () => 
    !props.roleFilter ? props.onRoleFilter?.(props.datos.roleName) : props.onRoleFilter?.(null)
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-12">
      ...
      <div className="text-center flex flex-col items-center">
        ...
        <Button onClick={handleClick} className="w-full mt-4">{props.datos?.roleName}</Button>
      </div>
